...
<head>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        BANK LIST OF <%=us1.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>BANK NAME</td><td>ACCOUNT</td><td>IFSC</td><td>BRANCH</td><td>TYPE</td><td>BALANCE</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from bank";        
                                     ...
                                     <tr><td><%=us.getString("bankname")%></td><td><%=us.getString("account")%></td><td><%=us.getString("ifsc")%></td><td><%=us.getString("branch")%></td><td><%=us.getString("actype")%></td><td><%=us.getString("balance")%></td></tr>
