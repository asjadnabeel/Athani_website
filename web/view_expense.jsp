                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Expense Details Of <%=us7.getString("name")%>
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                  <div class="panel-body">
                                   <table style="width: 100%;text-align: center">
                                     ...
                                     <tr style="background-color: #6a9fec"><td>NAME</td><td>PARTICULAR</td><td>AMOUNT</td><td>DATE</td></tr>
                                     <%
                                         String j="";
                                         int m=0;
                                         String k="select * from account_expense";        
                                     ...
                                     {
                                     %> 
                                     <tr><td><a href="view_expense.jsp?name1=<%=us.getString("idaccount_expense")%>"><%=us.getString("name")%></td><td><%=us.getString("particular")%></td><td><%=us.getString("amount")%></td><td><%=us.getString("dat")%></td></tr>
                        ...
                        <div id="search-2" class="widget widget_search">
                            ...
                            <div class="searchform">
								...
								<table>
                                         ...
                                         if(m1!=1)
                                         {
                                             k1="select * from account_expense where idaccount_expense='"+j1+"'";        
                                    ...
                                    %>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> : <%=us1.getString("salarymonth")%></td>
                                            </tr>
                                            <tr>
