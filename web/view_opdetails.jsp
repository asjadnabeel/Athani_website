    ...
    <div id="page" class="hfeed site"><!-- start page wrapper -->
        ...
        <div class="head-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">OP Details</h2>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     ResultSet us1=c.select(h);
                                     if(us1.next())
                                     {
                                     
                                     %>
                                        OP Details Of <%=us1.getString("name")%>
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                  <div class="panel-body">
                                   <table style="width: 100%;text-align: center">
                                     ...
                                     <tr style="background-color: #6a9fec"><td>OP TYPE</td><td>REG NO.</td><td>DOCTOR</td><td>DATE</td><td>YEAR</td><td>MONTH</td><td>PATIENT</td><td>BY STANDER</td></tr>
                                     <%
                                       
                                             String k="select * from opdetails";
                                             ...
                                             %> 
                                             <tr><td><%=us.getString("optype")%></td><td><%=us.getString("regno")%></td><td><%=us.getString("doctor")%></td><td><%=us.getString("dat")%></td><td><%=us.getString("year")%></td><td><%=us.getString("month")%></td><td><%=us.getString("pname")%></td><td><%=us.getString("bystander")%></td></tr>
								...
								<table>
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> : ATHANI <br>&nbsp;Near Indian Oil Petrol Pump
&nbsp;Parannur (po) Narikkuni,673 585<br> &nbsp;Calicut</td>
                                            </tr>
											<tr>
										...
										<td> : 0495 2247412</td>
                                            ...
                                            <tr>
                                                ...
                                                <td> : 9446 64 67 63 (Secretary)<br>&nbsp;&nbsp;9447 16 67 02 (Chairman)<br>&nbsp;&nbsp;9656 88 79 08 (Manager)</td>
                                            </tr>
                                            <tr>
                                                <td><strong>Email</strong></td>
                                                <td> : <a href="mailto:thaninarikkuni@gmail.com">athaninarikkuni@gmail.com</a></td>
                                            </tr>
