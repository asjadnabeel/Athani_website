...
<head>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Purchase Details Of <%=us1.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>SUPPLIER NAME</td><td>INVOICE NUMBER</td><td>BILL AMOUNT</td><td>MEDICINE NAME</td><td>BATCH NO</td><td>QUANTITY</td><td>RATE</td><td>EXPIRY</td><td>PRODUCT DATE</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from purchase";        
                                     ...
                                     <tr><td><%=us.getString("suplayername")%></td><td><%=us.getString("invoicenum")%></td><td><%=us.getString("billamount")%></td><td><%=us.getString("medname")%></td><td><%=us.getString("batchno")%></td><td><%=us.getString("qty")%></td><td><%=us.getString("mrp")%></td><td><%=us.getString("expd")%></td><td><%=us.getString("prdte")%></td></td></tr>
