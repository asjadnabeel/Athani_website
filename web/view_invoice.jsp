...
<head>
    ...
    <title>View Invoice Report</title>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Invoice Details Of <%=us1.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>Supplier Name</td><td>Invoice Number</td><td>Bill Amount</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from invoice";        
                                     ...
                                     <tr><td><%=us.getString("suplayername")%></td><td><%=us.getString("invoicenum")%></td><td><%=us.getString("billamount")%></td></tr>
