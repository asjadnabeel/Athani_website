...
<head>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>CODE</td><td>NAME</td><td>PHONE</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from doctors";        
                                     ...
                                     <tr><td><%=us.getString("code")%></td><td><%=us.getString("name")%></td><td><%=us.getString("mob")%></td></td></tr>
