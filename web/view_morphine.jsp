    ...
    <div id="page" class="hfeed site"><!-- start page wrapper -->
        ...
        <div class="head-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">MORPHINE VIEW</h2>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Morphine Details Of <%=us1.getString("name")%>
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                  <div class="panel-body">
                                   <table style="width: 100%;text-align: center">
                                     ...
                                     <tr style="background-color: #6a9fec"><td>MG</td><td>QUANTITY</td><td>ISSUE</td><td>EXPIRY</td><td>DATE</td></tr>
                                     <%
                                       
                                             String k="select * from morphine";
                                             ...
                                             %> 
                                             <tr><td><%=us.getString("mg")%></td><td><%=us.getString("qty")%></td><td><%=us.getString("issue")%></td><td><%=us.getString("exp")%></td><td><%=us.getString("dte")%></td></tr>
