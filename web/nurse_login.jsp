    ...
    <div id="page" class="hfeed site"><!-- start page wrapper -->
        ...
        <div class="head-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">Nurse Login</h2>
                            ...
                            <div class="post format-contact hentry">
                                ...
                                <div class="inner">
                                    ...
                                    <div>
										...
										<hr>
										<form action="nurse_login_action.jsp" method="post">
                                        <div class="row contact-form">
                                            ...
                                            <div class="col-lg-6">
                                               Username  <input type="text" class="form-control" required placeholder="Enter UserName" name="name">
                                            </div><!-- end col -->
											 <div class="col-lg-6">
