...
<head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Account Report</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Account Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>DATE</td><td>INCOME</td><td>AMOUNT</td><td>EXPENSE</td><td>AMOUNT</td><td>MONTH</td><td>YEAR</td></tr>
    </thead>
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from acreport";        
                                     ...
                                     {
                                     %> 
                                     <tr><td><%=us.getString("dat")%></td><td><%=us.getString("incometype")%></td><td><%=us.getString("iamount")%></td><td><%=us.getString("exptype")%></td><td><%=us.getString("eamount")%></td><td><%=us.getString("month")%></td><td><%=us.getString("year")%></td></tr>
