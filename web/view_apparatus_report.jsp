...
<head>
    ...
    <title>View Apparatus Report</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Apparatus Report</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Apparatus Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>DATE</td><td>ITEM</td><td>ADDRESS</td><td>C/O</td><td>MOBILE</td><td>PATIENT NAME</td><td>STATUS</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from aparutus";        
                                     ...
                                     <tr><td><%=us.getString("dat")%></td><td><%=us.getString("itemname")%></td><td><%=us.getString("ad")%></td><td><%=us.getString("co")%></td><td><%=us.getString("mob")%></td><td><%=us.getString("pname")%></td><td><%=hj%></td></tr>
