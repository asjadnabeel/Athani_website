    ...
    <div id="page" class="hfeed site"><!-- start page wrapper -->
                        ...
                        <nav id="primary-navigation" class="site-navigation navbar-collapse collapse" role="navigation">
				        	<div class="nav-menu">
    							<ul class="menu">
                                    ...
                                    <li  class="active"><a href="add_nurses.jsp">ADD NURSE</a></li>
        ...
        <div class="head-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">Add Nurses</h2>
                            ...
                            <div class="post format-contact hentry">
                                ...
                                <div class="inner">
                                    ...
                                    <div>
                                        <p>Register Nurses</p>
										<hr>
										<form action="add_nurse.jsp" method="post" name="form1">
                                        <div class="row contact-form">
                                            <div class="col-lg-6">
                                               Name  <input type="text" class="form-control" required placeholder="Enter UserName" name="name">
                                            </div><!-- end col -->
											 <div class="col-lg-6">
                                               email <input type="text" class="form-control" required placeholder="Enter email" name="email">
                                            </div>
                                            <div class="col-lg-6">
                                               phone  <input type="text" class="form-control" required placeholder="Enter Phone" name="phone">
                                            </div><!-- end col -->
											 <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-12">
                                                <input name="submit" type="submit" id="button" value="Add" onclick="return ValidateEmail(document.form1.email,document.form1.phone)">
                                            </div>
                                        </div><!-- end row -->
										</form>
