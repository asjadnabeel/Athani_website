...
<html>
    ...
    <body>
       ...
       String s="select * from add_nurse where id='"+id+"'";
       ...
       if(is.next())
       {
           ...
           {
               String p="update add_nurse set status='active' where id='"+id+"'";
               int g=c.insert(p);
               if(g>0)
               {
                   response.sendRedirect("view_nurses_1.jsp");
               }
           }
           else
           {
               String p="update add_nurse set status='blocked' where id='"+id+"'";
               int g=c.insert(p);
               if(g>0)
               {
                   response.sendRedirect("view_nurses_1.jsp");
