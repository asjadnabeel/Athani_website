                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                  <div class="panel-body">
                                   <table style="width: 100%;text-align: center">
                                     ...
                                     <tr style="background-color: #6a9fec"><td>DATE</td><td>PRESCRIPTION</td><td>DESCRIPTION</td></tr>
                                     <%
                                         String j="";
                                         String k="";
                                         int m=0;
                                             ...
                                             {
                                             %> 
                                             <tr><td><%=us.getString("date1")%></td><td><a href="doctor_view_prescription.jsp?name2=<%=us.getString("id")%>&name1=<%=j%>">Click</a></td><td><%=us.getString("des")%></td></tr>
                            ...
                            <div class="searchform">
								...
								<table>
                                         ...
                                         if(m1!=1)
                                         {
                                             ...
                                             <textarea style="width: 100%;height: 250px;"><%=uw.getString("pres")%></textarea>
                                              <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>to delete <a href="doctor_delete_prescription.jsp?name1=<%=j1%>&id=<%=j2%>">CLICK HERE</a></td>
                                            </tr>
                                                                    <%
                                             }
                                         }
                                    ...
                                    %>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>to add Prescription <a href="doctor_add_prescription.jsp?name1=<%=j1%>&id1=dd">CLICK HERE</a></td>
                                            </tr>
