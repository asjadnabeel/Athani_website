...
<head>
    ...
    <title>View Committee Report</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Committee Report</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
            ...
            <div class="container" >
                ...
                <div class="col-md-12">    
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     <%
                                     Connclass c=new Connclass(pa);    
                                     String h="select * from registration";
                                     ResultSet us7=c.select(h);
                                     if(us7.next())
                                     {
                                     
                                     %>
                                        Committee Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>FROM YEAR</td><td>FROM MONTH</td><td>TO YEAR</td><td>TO MONTH</td><td>NAME</td><td>POST</td><td>CHARGE</td><td>MOBILE</td><td>UNIT NAME</td><td>AGE</td><td>ADDRESS</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from committy";        
                                     ...
                                     <tr><td><%=us.getString("fromyr")%></td><td><%=us.getString("frmonth")%></td><td><%=us.getString("toyr")%></td><td><%=us.getString("tomonth")%></td><td><%=us.getString("name")%></td><td><%=us.getString("postt")%></td><td><%=us.getString("charge")%></td><td><%=us.getString("mob")%></td><td><%=us.getString("unitname")%></td><td><%=us.getString("age")%></td><td><%=us.getString("address")%></td></tr>
