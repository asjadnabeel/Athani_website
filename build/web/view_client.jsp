...
<head>
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Client Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>NAME</td><td>type</td><td>CDATE</td><td>MOBILE</td><td>AMOUNT</td><td>C/O</td><td>CODE</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from client";        
                                     ...
                                     <tr><td><%=us.getString("name")%></td><td><%=us.getString("type")%></td><td><%=us.getString("cdate")%></td><td><%=us.getString("mob")%></td><td><%=us.getString("amount")%></td><td><%=us.getString("co")%></td><td><%=us.getString("code")%></td></tr>
