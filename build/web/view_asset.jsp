    ...
    <div id="page" class="hfeed site"><!-- start page wrapper -->
        ...
        <div class="head-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">ASSET VIEW</h2>
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                  <div class="panel-body">
                                   <table style="width: 100%;text-align: center">
                                     ...
                                     <tr style="background-color: #6a9fec"><td>ITEM NAME</td><td>QUANTITY</td><td>STATUS</td></tr>
                                     <%
                                       
                                             String k="select * from aseet";
                                            
                                             ResultSet us=c.select(k);
                                             while(us.next())
                                             {
                                                 String jl=us.getString("status");
                                                 if(jl==null)
                                             ...
                                             %> 
                                             <tr><td><%=us.getString("itemname")%></td><td><%=us.getString("quantity")%></td><td><%=jl%></td></tr>
