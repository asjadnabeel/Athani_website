    ...
    <div id="page" class="hfeed site"><!-- start page wrapper -->
        ...
        <div class="head-title">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="page-title">View Nurses</h2>
                                ...
                                <div class="inner">
                                    ...
                                    <div>
										...
										<hr>
                                             ...
                                             String k="select * from add_nurse where id='"+id+"'";        
                                     ...
                                     if(us.next())
                                     {
                                        String id1=us.getString("id");
                                                                                ...
                                                                                %>
										<form action="add_nurse_edit.jsp" method="post" name="form1">
