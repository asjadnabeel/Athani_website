...
<head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Bank Income</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    ...
                                    <%
                                     ...
                                     %>
                                        Bank Income Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>DATE</td><td>BANK NAME</td><td>NARRATION</td><td>AMOUNT</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from bankincome";        
                                     ...
                                     <tr><td><%=us.getString("dat")%></td><td><%=us.getString("bankname")%></td><td><%=us.getString("narration")%></td><td><%=us.getString("amount")%></td></tr>
