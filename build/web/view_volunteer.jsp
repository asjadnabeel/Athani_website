...
<head>
    ...
    <title>View Volunteer Report</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Volunteer Report</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Volunteer Details Of <%=us1.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>NAME</td><td>GENDER</td><td>ADDRESS</td><td>PAN</td><td>WARD</td><td>MOBILE</td><td>BLOOD</td><td>AGE</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from volunteer";        
                                     ...
                                     <tr><td><%=us.getString("name")%></td><td><%=us.getString("gender")%></td><td><%=us.getString("addre")%></td><td><%=us.getString("pan")%></td><td><%=us.getString("Ward")%></td><td><%=us.getString("mob")%></td><td><%=us.getString("blood")%></td><td><%=us.getString("age")%></td></tr>
