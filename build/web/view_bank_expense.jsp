...
<head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Bank Expense</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Bank Expense Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>NUMBER</td><td>CHEQUE NO</td><td>BANK NAME</td><td>AMOUNT</td><td>REMARK</td><td>DATE</td><td>BALANCE</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from bankexpence";        
                                     ...
                                     <tr><td><%=us.getString("bno")%></td><td><%=us.getString("cheqno")%></td><td><%=us.getString("bankname")%></td><td><%=us.getString("amount")%></td><td><%=us.getString("remark")%></td><td><%=us.getString("dte")%></td><td><%=us.getString("balance")%></td></tr>
