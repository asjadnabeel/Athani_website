                    ...
                    <div class="row">
                        ...
                        <div class="logo navbar-brand">
                          ...
                          <nav id="primary-navigation" class="site-navigation navbar-collapse collapse" role="navigation">
				        	<div class="nav-menu">
    							<ul class="menu">
    					<li><a href="nurse_view_patients.jsp">Home</a></li>			
                                   ...
                                   <table style="width: 100%;text-align: center">
                                     ...
                                     <%
                                         ...
                                         int m=0;
                                             ...
                                             {
                                             %> 
                                             <tr><td><%=us.getString("date1")%></td><td><a href="nurse_view_prescription.jsp?name2=<%=us.getString("id")%>&name1=<%=j%>">Click</a></td><td><%=us.getString("des")%></td></tr>
