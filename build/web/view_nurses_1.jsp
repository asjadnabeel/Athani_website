...
<head>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
    					...
    					<li><a href="admin_home.jsp">Home</a></li>
                                    ...
                                    <li  class="active"><a href="view_nurses_1.jsp">EDIT NURSES</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Nurse Report</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Nurses Details Of <%=us1.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>NAME</td><td>PHONE</td><td>EMAIL</td><td>EDIT</td><td>STATUS</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from add_nurse";        
                                     ...
                                     <tr><td><%=us.getString("name")%></td><td><%=us.getString("phone")%></td><td><%=us.getString("email")%></td><td><a href="editnurses.jsp?id=<%=id%>">CLICK</a></td><td><a href="validate_1.jsp?id=<%=id%>"><%=us.getString("status")%></a></td></tr>
