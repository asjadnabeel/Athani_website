                    ...
                    <div id="primary" class="content-area">
                        <div id="content" class="site-content">
                            ...
                            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                ...
                                <form action="doctor_view_patients.jsp" method="post">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                  <div class="panel-body">
                                   <table style="width: 100%;text-align: center">
                                     ...
                                     {
                                     %> 
                                     <tr><td><a href="doctor_view_patients.jsp?name1=<%=us.getString("regno")%>&name=<%=j%>"><%=us.getString("regno")%></td><td><%=us.getString("pname")%></td><td><%=us.getString("age")%></td><td><%=us.getString("ward")%></td></tr>
                                    ...
                                    %>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>to add Prescription <a href="doctor_add_prescription.jsp?name1=<%=j1%>&id1=ll">CLICK HERE</a></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>to view added Prescription <a href="doctor_view_prescription.jsp?name1=<%=j1%>&name2=null">CLICK HERE</a></td>
                                            </tr>
                                           <%
                                     }
                                         } 
