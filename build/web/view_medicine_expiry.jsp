...
<head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Medicine Expiry Report</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Medicine Expiry Details Of <%=us1.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>SUPPLIER</td><td>INVOICE</td><td>MEDICINE</td><td>QUANTITY</td><td>PURCHASE DATE</td><td>EXPIRY DATE</td><td>SHOWING EXPIRY</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from medicineexiprity";        
                                     ...
                                     <tr><td><%=us.getString("suplayername")%></td><td><%=us.getString("invoice")%></td><td><%=us.getString("medname")%></td><td><%=us.getString("qty")%></td><td><%=us.getString("purchasedate")%></td><td><%=us.getString("expdate")%></td><td><%=us.getString("showingexpdate")%></td></tr>
