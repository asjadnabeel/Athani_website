...
<head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Employess View</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    ...
                                    <%
                                     ...
                                     %>
                                        Employees Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>NAME</td><td>GENDER</td><td>PHONE</td><td>POST</td><td>POST TYPE</td><td>SALARY TYPE</td><td>AMOUNT</td><td>EMPLOYEE DATE</td></tr>
                                     <%
                                         String j="";
                                         int m=0;
                                         String k="select * from employee";        
                                     ...
                                     {
                                     %> 
                                     <tr><td><%=us.getString("name")%></td><td><%=us.getString("gen")%></td><td><%=us.getString("phon")%></td><td><%=us.getString("pst")%></td><td><%=us.getString("ptype")%></td><td><%=us.getString("salarytpe")%></td><td><%=us.getString("amount")%></td><td><%=us.getString("empdte")%></td></tr>
