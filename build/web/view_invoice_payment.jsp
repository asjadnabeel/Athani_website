...
<head>
    ...
    <title>View Invoice Payment</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Invoice Payment</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Invoice Payment Details Of <%=us1.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    <thead>
      <tr style="background-color: #6a9fec"><td>Supplier Name</td><td>Invoice</td><td>Bill Amount</td><td>Payment</td><td>Date</td></tr>
    </thead> 
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from invoicepayment";        
                                     ...
                                     <tr><td><%=us.getString("suplayername")%></td><td><%=us.getString("invoicenum")%></td><td><%=us.getString("billamount")%></td><td><%=us.getString("payment")%></td><td><%=us.getString("dte")%></td></tr>
