            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h2 class="page-title">Doctor Report</h2>  
                    </div><!-- end column -->
                </div><!-- end row -->
            </div><!-- end container -->
        </div><!-- end head-title -->                                                                                                                  
                                ...
                                <div class="panel-heading" role="tab" id="headingOne">
                                  <h4nj class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                     ...
                                     %>
                                        Doctors Details Of <%=us7.getString("name")%>
  ...
  <table class="table table-striped table-bordered table-hover table-condensed">
    ...
    <tbody>
      <%
                                         String j="";
                                         int m=0;
                                         String k="select * from add_doctor";        
                                     ...
                                     <tr><td><%=us.getString("name")%></td><td><%=us.getString("phone")%></td><td><%=us.getString("email")%></td><td><a href="editdoctors.jsp?id=<%=id%>">CLICK</a></td><td><a href="validate.jsp?id=<%=id%>"><%=us.getString("status")%></a></td></tr>
